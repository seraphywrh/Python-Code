...
socket1.connect("tcp://ec2-18-216-80-55.us-east-2.compute.amazonaws.com:5051")
socket2.setsockopt(zmq.RCVTIMEO, 500)
#socket2.connect("tcp://localhost:5050")
socket2.connect("tcp://ec2-18-216-80-55.us-east-2.compute.amazonaws.com:5050")
    ...
    for event in pygame.event.get():
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_LEFT:
                my_id = 'b'
                socket1.send_string("id_confirmed 1")
                #print("x")
            elif event.key == pygame.K_RIGHT:
                socket1.send_string("id_confirmed 2")
                my_id = 'g'
                #print("x")
